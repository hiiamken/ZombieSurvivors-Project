 ...
 * Separated from GameStateManager for better maintainability.
 */
public class GameOverScreen {
    ...
    /**
     * Set the sound manager for button click sounds.
     */
    ...
    /**
     * Initialize the game over screen with callbacks.
     */
    public void initialize(Runnable onPlayAgain, Runnable onBackToMenu) {
    ...
    public void render() {
        ...
        drawBackground(screenWidth, screenHeight, fadeAlpha);
     ...
     */
    private void drawBackground(float width, float height, float alpha) {
